...
class TextQnaWrapperTextQnaQuestionPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    question: Optional[str] = dataclasses.field(metadata={'path_param': { 'field_name': 'question', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class TextQnaWrapperTextQnaQuestionPostResponse:
