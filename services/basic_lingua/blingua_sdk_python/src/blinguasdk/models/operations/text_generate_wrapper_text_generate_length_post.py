...
class TextGenerateWrapperTextGenerateLengthPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    length: Optional[str] = dataclasses.field(metadata={'path_param': { 'field_name': 'length', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class TextGenerateWrapperTextGenerateLengthPostResponse:
