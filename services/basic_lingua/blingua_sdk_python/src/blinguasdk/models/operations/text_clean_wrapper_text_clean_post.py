...
class TextCleanWrapperTextCleanPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    clean_info: str = dataclasses.field(metadata={'query_param': { 'field_name': 'clean_info', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class TextCleanWrapperTextCleanPostResponse:
