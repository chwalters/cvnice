...
class TextSummarizeWrapperTextSummarizeSummaryLengthPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    summary_length: Optional[str] = dataclasses.field(metadata={'path_param': { 'field_name': 'summary_length', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class TextSummarizeWrapperTextSummarizeSummaryLengthPostResponse:
