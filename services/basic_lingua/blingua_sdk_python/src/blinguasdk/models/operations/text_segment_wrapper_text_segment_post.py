...
class TextSegmentWrapperTextSegmentPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    request_body: str = dataclasses.field(metadata={'request': { 'media_type': 'text/plain' }})
    logical: Optional[bool] = dataclasses.field(default=True, metadata={'query_param': { 'field_name': 'logical', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class TextSegmentWrapperTextSegmentPostResponse:
