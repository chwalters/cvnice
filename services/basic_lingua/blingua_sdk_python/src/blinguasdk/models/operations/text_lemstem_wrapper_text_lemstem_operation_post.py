...
from ...models.components import lemstemop as components_lemstemop
from ...models.components import textresult as components_textresult
from typing import Optional


@dataclasses.dataclass
class TextLemstemWrapperTextLemstemOperationPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    operation: components_lemstemop.LemStemOp = dataclasses.field(metadata={'path_param': { 'field_name': 'operation', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class TextLemstemWrapperTextLemstemOperationPostResponse:
