...
class TextSenseDisambiguationWrapperTextSenseDisambiguationPostRequest:
    UNSET='__SPEAKEASY_UNSET__'
    word_to_disambiguate: str = dataclasses.field(metadata={'query_param': { 'field_name': 'word_to_disambiguate', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class TextSenseDisambiguationWrapperTextSenseDisambiguationPostResponse:
